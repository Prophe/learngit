...
<div id="main">
   ...
   **/
        ...
        -->
        <%  Object obj=request.getAttribute("oldpro"); 
            Product p=(Product)obj;
            String name=p.getPname();
            String type= new CateDaoImpl().getCat(p.getCid()).getCname();
            String pro_no=p.getPno();
            Double pro_price=p.getPrice();
            int online=p.getOnline();
            String pro_sx=null;
            if(online==1){
            	 pro_sx="是";
            }else{
            ...
            String edit= p.getPdetail();
        %>
				<form action="proadd.do" method="post">
			<table class="tb">
				<tr>
					<td class="td_left">商品名称</td>
					<td><input class="_input" placeholder="<%=name %>" required="" name="pro_name" type="text"/></td>
				</tr>
			
				<tr>
					<td class="td_left">商品类别</td>
					<td>
						<select name="type" placeholder="<%=type %>" required="" id="region" onchange="selectProv(this)">
				...
				<tr>
					...
					<td><input class="_input" placeholder="<%=pro_no %>" required="" name="pro_no" type="text" /></td>
				</tr>
				...
				<tr>
					...
					<td><input class="_input" placeholder="<%=pro_price %>" required="" name="pro_price" type="text" /></td>
				</tr>
				
				<tr>
					<td class="td_left">是否上线</td>
					<td><input name="pro_sx" placeholder="<%=pro_sx %>" required="" value="1" type="radio" />是<input name="pro_sx" value="0" type="radio" />否</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<textarea id="edit" placeholder="<%=name %>" required="" name="edit" ></textarea>

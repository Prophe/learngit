...
<script type="text/javascript" src="js/commodity.js" ></script>
	...
	<body>
		...
		<div id="cateadd"  style="border:1px solid palevioletred;height: 0px;width: 400px; position: absolute;left: 32%;;">
					<form action="addcate.do?reqType=3" method="post" >
					        
							<tr ><h1>修改分类信息</h1></tr>
							<tr><span style="margin-left:12px;width:300px;"><%CateDao s=new CateDaoImpl(); String ycname=(String)request.getAttribute("ycname");String cid=(String)request.getAttribute("ycid");%>
							 <input type="hidden" name="cid" value=<%=cid %>>
							分类名称<input type="text"  placeholder="<%=ycname %>" required="" name="upcname" style="width: 300px"  />
							<tr style="display: block;" >
						 		<td> 
								 <span style="margin-left:12px;width:300px;overflow:hidden;" > 
						            上级分类<select style="width:300px;height:25px"  id="SS" name="uppname"> 
